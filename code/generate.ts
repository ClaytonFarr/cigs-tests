...
(async () => {
  ...
  * If using JSON object as input:
    ...
    4. context: 'extracted prompt' | operation: 'generate' | prompt: (concatenated system + user message with input and instructions)
  ...
  * If using string as input:
    ...
    2. context: 'Processed string input' | result: { genre: "Country" }
    2. context: 'Operation 1 Input' | data: { genre: "Country" }
    3. context: 'init' | operation: 'generate' | input: { genre: "Country" } | instruction: '…' | examples: '[…]'
    4. context: 'extracted prompt' | operation: 'generate' | prompt: (concatenated system + user message with input and instructions)
    5. context: 'Operation 1 Output' | data: (array of generated content)
  ...
  * Notes
    ...
    - String input can lead to inconsistent results, e.g.
